 ...
 * 3. Also, there will be no leading zeroes in the given and not as "0010".
 * Input Format
 ...
 * Output Format:
 * For each test case, return the minimum number of
 ...
 * becomes vacant). from platform 2 (platform
 * Train 4 departed at 1130 from platform 3 (platform also becomes vacant).
 * Train 2 departed at 1200 from platform 1 (platform also becomes vacant).
 ...
 * Thus, minimum 3 platforms are needed for the give input.
 * In test case 2. For the given input, the following wil
 * be the schedule of the trains:
 * Train 1 arrived at 100 on platform 1.
 * Train 2 arrived at 200 from platform 2 (as platform is occupied by train 1).
...
public class Platforms {
    ...
    public static int calculateMinPatforms(int at[], int dt[], int n) {
        ...
        int curr=1, max=1,curAT,curDT,i=1,j=0;
